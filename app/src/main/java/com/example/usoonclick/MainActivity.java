...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Asignando la lista de elementos de la clase Adapter al
        //componente ListView
        lstdepartamentos.setAdapter(adapter);
        //Recuperando imagen de la sesión actual
        //Se usa para evitar que la imagen se pierda cuando se cambia
        //entre modo claro y modo oscuro
        ...
        @SuppressLint("UseSwitchCompatOrMaterialCode") Switch swModo = findViewById(R.id.SwCambiarModo);
                ...
                TimePickerDialog timePickerDialog = new
                        ...
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                @SuppressLint("DefaultLocale") String hora = hourOfDay + ":" + String.format("%02d", minute);
